var shop_items = [{
        ...
        img: "/static/img/DEMON_2.png",
        big_img: "/static/img/DEMON_2_big.png",
        cost: 32000,
        count: 0
    },
    {
        name: "Schecter OMEN-8",
        img: "/static/img/OMEN-8_2.png",
        big_img: "/static/img/OMEN-8_big.png",
        cost: 24000,
        count: 0
    },
    {
        name: "Schecter C-5 BASS SGR",
        img: "/static/img/C-5%20SGR_2.png",
        big_img: "",
        cost: 17000,
        count: 0
    }];
...
function init() { //Функция формирования товаров
    var catalog = document.getElementsByClassName("pr")[0], i, item, img, span;
